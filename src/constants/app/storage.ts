export enum StorageKeysEnum {
  AUTH_SESSION_USER = "as-u",
  AUTH_SESSION_TOKEN = "as-t",
  AUTH_SESSION_WEBPAGES = "as-wp",
  STOCK_SETTINGS = "stock-settings",
  STOCK_INCOMING_BATCHES = "stock-incoming-batches",

  // monitoring
  MONITORING_SALES_COMPANIES_FILTER = "m.monitoring.sales.companies-filter",
  MONITORING_SALES_MARKET_FILTER = "m.monitoring.sales.market-filter",
