...
import { GetTiposArrend, GetUserSimulations } from '@/services/webApi/cash-flow-api'
import { GetArrendTypesResponse, GetUserSimulationsResponse } from '@/types/api/cash-flow'
...
export const useGetUserSimulations = ({ date, fetchQuery }: UseGetUserSimulationsRequest) => {
