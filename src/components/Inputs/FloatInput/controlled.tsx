...
export const FloatInputControlled = forwardRef<HTMLInputElement, FloatInputControlledProps>(
  ({ name, label, readonly, size = 'medium' }, ref) => {
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      if (ref && typeof ref !== 'function') {
        ;(ref as React.RefObject<HTMLInputElement>).current!.value = isNaN(parsedValue)
          ? '0.00'
