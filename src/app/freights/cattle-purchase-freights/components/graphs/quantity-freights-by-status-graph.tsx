...
import { ResponsiveContainer, PieChart, Pie, Cell, Tooltip, Legend, LegendProps } from 'recharts'
...
export function QuantityFreightsByStatusGraph({ data }: QuantityFreightsByStatusGraphProps) {
    ...
    >
      {payload.map((entry: any, index) => (
        ...
        >
          ...
          />
          <span style={{ fontFamily: 'roboto', fontSize: '9px' }}>
