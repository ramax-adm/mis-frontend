...
export function CattlePurchaseFreightsResumeSection({
  ...
  const { data: resumedFreights, isFetching } =
  ...
  return (
    <Box
      sx={{ display: "flex", flexDirection: "column", gap: 1, marginTop: 0.5 }}
    >
      <Grid container spacing={1}>
          ...
          >
            ...
            <Box sx={{ display: "inline-flex", gap: 2 }}>
              ...
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                ...
                <Typography fontSize={"10px"} fontWeight={700}>
                  {toLocaleString(
                    resumedFreights.totals.cattleQuantityActiveFreights
                  )}
                </Typography>
              </Box>
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                <Typography fontSize={"8px"}>Med. Dias (Até HOJE) </Typography>
                <Typography fontSize={"10px"} fontWeight={700}>
                  {toLocaleString(resumedFreights.totals.openDays)}
                </Typography>
              </Box>
            </Box>
          </Box>
          ...
          >
            ...
            <Box sx={{ display: "inline-flex", gap: 2 }}>
              ...
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                ...
                <Typography fontSize={"10px"} fontWeight={700}>
                  {toLocaleString(
                    resumedFreights.totals.cattleQuantityNoFreights
                  )}
                </Typography>
              </Box>
            </Box>
          ...
          >
            ...
            <Box sx={{ display: "inline-flex", gap: 2 }}>
              ...
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                ...
                <Typography fontSize={"10px"} fontWeight={700}>
                  {toLocaleString(
                    resumedFreights.totals.cattleQuantityClosedFreights
                  )}
                </Typography>
              </Box>
              <Box sx={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            ...
            <Box sx={{ display: "inline-flex", gap: 2 }}>
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                <Typography fontSize={"8px"}>Qtd.</Typography>
                <Typography fontSize={"10px"} fontWeight={700}>
                  {resumedFreights.totals.quantity}
                </Typography>
              </Box>
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                <Typography fontSize={"8px"}>Σ Cbs</Typography>
                <Typography fontSize={"10px"} fontWeight={700}>
                  {toLocaleString(resumedFreights.totals.cattleQuantity)}
                </Typography>
              </Box>
            </Box>
          </Box>
        ...
        <Grid item xs={12} md={3.5}>
          ...
          >
            <PriceByFreightCompanyCard
              data={resumedFreights.priceByFreightCompany}
            />
          </Box>
        </Grid>
      </Grid>
      ...
      <Grid container spacing={1}>
        <Grid item xs={12} md={3}>
          <FreightsOverPriceTableCard
            data={resumedFreights.freightsOverPriceTable}
            totals={resumedFreights.totals}
          />
        </Grid>

        <Grid item xs={12} md={3}>
          <FreightsByFreightCompanyCard
            data={resumedFreights.freightsByFreightCompany}
          />
        </Grid>
        <Grid item xs={12} md={3}>
          <FreightsByCattleAdvisorCard
            data={resumedFreights.freightsByCattleAdvisor}
          />
        </Grid>
        <Grid item xs={12} md={3}>
          <FreightsByFreightTypeCard
            data={resumedFreights.freightsByFreightType}
          />
        </Grid>
      </Grid>
    </Box>
