...
interface InvoicesWithSamePriceTotalsProps {
  data?: GetBusinessAuditOverviewDataResponse["invoicesWithSamePriceTotals"];
}
export function InvoicesWithSamePriceTotals({
  data,
}: InvoicesWithSamePriceTotalsProps) {
  return (
    <Box
      sx={{
        padding: "2px",
