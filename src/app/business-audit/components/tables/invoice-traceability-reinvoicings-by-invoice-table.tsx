...
type InvoiceTraceabilityReinvoicingsByInvoiceTableData =
  GetBusinessAuditInvoiceTraceabilityDataResponse["reInvoicings"]["data"][1] & {
    nfId: string;
    dateFormated: string;
    company: string;
    client: string;
...
interface InvoiceTraceabilityReinvoicingsByInvoiceTableProps {
  data?: GetBusinessAuditInvoiceTraceabilityDataResponse["reInvoicings"]["data"];
  isFetching: boolean;
  setSectionStates: (
    states: Partial<{
...
export function InvoiceTraceabilityReinvoicingsByInvoiceTable({
  data,
  isFetching,
  setSectionStates,
}: InvoiceTraceabilityReinvoicingsByInvoiceTableProps) {
...
const getData = ({
  ...
  data?: GetBusinessAuditInvoiceTraceabilityDataResponse["reInvoicings"]["data"];
}): InvoiceTraceabilityReinvoicingsByInvoiceTableData[] => {
  const marketMap = {
    [MarketEnum.ME]: "ME",
    [MarketEnum.MI]: "MI",
...
}): CustomTableColumn<InvoiceTraceabilityReinvoicingsByInvoiceTableData>[] => [
  {
