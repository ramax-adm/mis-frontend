...
type AccountsReceivableExpiredBucketsTableData = AccountReceivableItem & {
  company: string;
  client: string;
...
interface AccountsReceivableExpiredBucketsTableProps {
  data?: AccountReceivableItem[];
  isFetching: boolean;
}
export function AccountsReceivableExpiredBucketsTable({
  data,
  isFetching,
}: AccountsReceivableExpiredBucketsTableProps) {
  ...
  return (
    <CustomTable<AccountsReceivableExpiredBucketsTableData>
      columns={columns}
      rows={parsedData}
...
const getData = ({
  ...
  data?: AccountReceivableItem[];
}): AccountsReceivableExpiredBucketsTableData[] => {
  return data
    .map((i) => ({
      ...i,
...
const getColumns =
  (): CustomTableColumn<AccountsReceivableExpiredBucketsTableData>[] => [
    {
