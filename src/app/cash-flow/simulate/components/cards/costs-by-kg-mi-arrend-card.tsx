...
interface CostsByKgMiArrendCardProps {
  data: Pick<ProjectCostByKgResponse, 'costs' | 'total'>
}
export function CostsByKgMiArrendCard({ data }: CostsByKgMiArrendCardProps) {
  const columns = getColumns()
  return (
    <Card.Root sx={{ height: '120px' }}>
      <Card.Title>Custo Arrendamento R$/KG MI</Card.Title>
