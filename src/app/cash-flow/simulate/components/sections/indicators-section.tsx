  ...
  return (
    ...
    >
      <Grid item xs={6} md={4} lg={2}>
        <CostByKgMiIndicator
          data={simulationResults.parsedData.costsByKgProjection.kpis}
        />
      </Grid>
      <Grid item xs={6} md={4} lg={2}>
        <SallesByKgMiIndicator
          data={simulationResults.parsedData.costsByKgProjection.kpis}
        />
      </Grid>
      <Grid item xs={6} md={4} lg={2}>
      ...
      <Grid item xs={6} md={4} lg={2}>
        <SallesByKgMeIndicator
          data={simulationResults.parsedData.costsByKgProjection.kpis}
        />
      </Grid>
      <Grid item xs={6} md={4} lg={2}>
        <CostByKgFinalIndicator
          data={simulationResults.parsedData.costsByKgProjection.kpis}
        />
      </Grid>
      <Grid item xs={6} md={4} lg={2}>
        <SallesByKgFinalIndicator
          data={simulationResults.parsedData.costsByKgProjection.kpis}
        />
      </Grid>

      <Grid item xs={6} md={4} lg={2}>
        <GrossMarginMiIndicator
          data={simulationResults.parsedData.costsByKgProjection.kpis}
        />
      </Grid>
      <Grid item xs={6} md={4} lg={2}>
        <LiquidMarginMiIndicator
          data={simulationResults.parsedData.costsByKgProjection.kpis}
        />
      </Grid>
      <Grid item xs={6} md={4} lg={2}>
        <GrossMarginMeIndicator
          data={simulationResults.parsedData.costsByKgProjection.kpis}
        />
      </Grid>
      <Grid item xs={6} md={4} lg={2}>
        <LiquidMarginMeIndicator
          data={simulationResults.parsedData.costsByKgProjection.kpis}
        />
      </Grid>
      <Grid item xs={6} md={4} lg={2}>
        <GrossMarginFinalIndicator
          data={simulationResults.parsedData.costsByKgProjection.kpis}
        />
      </Grid>
      <Grid item xs={6} md={4} lg={2}>
        <LiquidMarginFinalIndicator
          data={simulationResults.parsedData.costsByKgProjection.kpis}
        />
      </Grid>
    </Grid>
