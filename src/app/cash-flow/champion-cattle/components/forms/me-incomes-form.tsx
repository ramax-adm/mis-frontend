...
import { DEFAULT_ME_INCOMES_FORM_VALUES } from "@/app/cash-flow/champion-cattle/constants/cash-flow-champion-cattle";
...
export const MeIncomesInputs = forwardRef<
  MeIncomesFormRef,
  MeIncomesInputsProps
>(({ setRendimentosMe, isSubmitting, onSimulate }, ref) => {
  ...
  return (
    ...
    >
      ...
      <Button
        onClick={handleSubmit(onSubmitMePricesForm)}
