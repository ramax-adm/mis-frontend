...
import { DEFAULT_RAW_MATERIAL_FORM_VALUES } from '@/constants/app/cash-flow-champion-cattle'
...
export const RawMaterialInputs = forwardRef<RawMaterialFormRef, RawMaterialInputsProps>(
  ({ setMatPrimaValores, onSimulate, isSubmitting }, ref) => {
    ...
    return (
      ...
      >
        ...
        <Grid item xs={5}>
          <NumberInput label='Cbs' size='small' name='cbs' control={control} error={errors.cbs} />
        </Grid>
        ...
        <Button onClick={handleSubmit(onSubmitRawMaterialForm)} disabled={isSubmitting}>
          SIMULAR
        </Button>
      </Grid>
    )
