...
import { DEFAULT_PROJECTION_FORM_VALUES } from "@/app/cash-flow/champion-cattle/constants/cash-flow-champion-cattle";
import {
  Operation,
  ProjectionControls,
  RawMaterialControls,
...
export type ProjectionControlsFormSchema = z.infer<
  typeof projectionControlsFormSchema
>;
...
>(({ setProjecaoValores, isSubmitting, onSimulate }, ref) => {
  ...
  return (
    ...
    >
      ...
      <Button
        onClick={handleSubmit(onSubmitOperationForm)}
