...
interface AnalysesMoreThanTwoExtraHoursByDepartmentGraphProps {
  data: MoreThanTwoExtraHoursByDepartment
}

export function AnalysesMoreThanTwoExtraHoursByDepartmentGraph({
  data,
}: AnalysesMoreThanTwoExtraHoursByDepartmentGraphProps) {
...
const getData = ({ data }: AnalysesMoreThanTwoExtraHoursByDepartmentGraphProps) => {
