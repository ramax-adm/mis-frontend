...
import {
  IrregularExtraHoursByDepartment,
  MoreThanTwoExtraHoursByDepartment,
...
interface AnalysesIrregularExtraHoursByDepartmentGraphProps {
  data: IrregularExtraHoursByDepartment
}

export function AnalysesIrregularExtraHoursByDepartmentGraph({
  data,
}: AnalysesIrregularExtraHoursByDepartmentGraphProps) {
...
const getData = ({ data }: AnalysesIrregularExtraHoursByDepartmentGraphProps) => {
  ...
  for (const key of keys) {
    response.push({
      ...
      quantity: data[key].registriesAmount,
    })
  }
