...
interface AnalysesMoreThanTwoExtraHoursByEmployeeTableProps {
  data: MoreThanTwoExtraHoursRegistriesByEmployee
}
export function AnalysesMoreThanTwoExtraHoursByEmployeeTable({
  data,
}: AnalysesMoreThanTwoExtraHoursByEmployeeTableProps) {
...
const getData = ({ data }: AnalysesMoreThanTwoExtraHoursByEmployeeTableProps) => {
